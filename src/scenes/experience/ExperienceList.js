    ...
    <div style={{ padding: 24, background: '#fff', minHeight: 360 }}>
      ...
      <Table
        ...
        columns={columns.concat({
          ...
          render: (text, record) => (
            <span>
              <Link to={`/experiences/edit/${text}`}>
                <EditOutlined style={{ fontSize: 20 }} />
              </Link>
              {!!record.deleted_at && (
                <Popconfirm
                  title="Are you sure to restore this experience?"
                  okText="Yes"
                  cancelText="No"
              ...
              <Popconfirm
                title={!!record.deleted_at ? 'Are you sure to delete this experience permanently?' : 'Are you sure to move this experience to trash?'}
                okText="Yes"
                cancelText="No"
