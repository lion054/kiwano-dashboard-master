...
class ExperienceCategoryList extends Component {
  state = {
    records: [],
    destinations: [],
    search: '',
  ...
  render = () => (
    <div style={{ padding: 24, background: '#fff', minHeight: 360 }}>
      <div style={{ marginBottom: 8 }}>
        <Link to="/experience_categories/new">
      ...
      <Table
        ...
        columns={columns.concat({
          ...
          render: (text, record) => (
            <span>
              <Link to={`/experience_categories/edit/${text}`}>
